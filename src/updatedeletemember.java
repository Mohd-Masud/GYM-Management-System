...
public class updatedeletemember extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String NIDNO=jTextField9.getText();
        String age=jTextField10.getText();
        String amount=jTextField11.getText();
        try
        {
        Connection con=connectionprovider.getcon();
        PreparedStatement ps=con.prepareStatement("update member set name=?,mobilenumber=?,email=?,fathername=?,mothername=?,nidnumber=?,age=?,amount=? where id=?");
        ps.setString(1, name);
        ps.setString(2, mobilenumber);
        ps.setString(3, email);
        ps.setString(4, fathername);
        ps.setString(5, mothername);
        ps.setString(6, NIDNO);
        ps.setString(7, age);
